...
class Shine(NamedTuple):
    name: str
    id: int
    normal: Requirements = Requirements()
...
ALL_REGIONS: list[SmsRegion] = [
    # Delfino Airstrip
    SmsRegion(AIRSTRIP, AIRSTRIP, shines=[
    ...
    SmsRegion(INIT, PLAZA, normal=Requirements([NozzleType.splasher]), shines=[
        ...
        Shine("Red Coin Field", 523092,
              Requirements([NozzleType.spray, NozzleType.rocket | NozzleType.hover]))], blue_coins=[
    ...
    SmsRegion(STATUE, PLAZA, normal=Requirements([NozzleType.splasher]), shines=[
        Shine("Boxing Clever 1", 523094),
        Shine("Boxing Clever 2", 523095),
        Shine("Chuckster", 523098),
        Shine("100 Coins", 523107, Requirements([NozzleType.hover | NozzleType.rocket]), hundred=True)], blue_coins=[
    ...
    # Bianco Hills
    SmsRegion("Bianco Entrance", BIANCO,
              shines=[Shine("100 Coins", 523100, Requirements([NozzleType.spray, NozzleType.hover]), hundred=True)],
              blue_coins=[
              ...
              normal=Requirements([NozzleType.spray]), ticketed=True, parent_region=STATUE),

    SmsRegion("Bianco 1", BIANCO, shines=[
        Shine("Road to the Big Windmill", 523000, normal=Requirements([NozzleType.splasher]))],
              parent_region="Bianco Entrance"),

    SmsRegion("Bianco 2", BIANCO, shines=[
        Shine("Down with Petey Piranha!", 523001, normal=Requirements([NozzleType.splasher, NozzleType.hover]),
              hard=Requirements([NozzleType.splasher]))], parent_region="Bianco 1"),

    SmsRegion("Bianco 3", BIANCO, Requirements(location="Bianco Hills - Down with Petey Piranha!"), shines=[
        ...
        Shine("Red Coins of the Hillside Cave", 523008,
              Requirements([NozzleType.hover]))], blue_coins=[
    ...
    SmsRegion("Bianco 4", BIANCO, Requirements(location="Bianco Hills - The Hillside Cave Secret"), shines=[
        Shine("Red Coins of Windmill Village", 523003,
              Requirements([NozzleType.hover | NozzleType.rocket]))], blue_coins=[
        BlueCoin("Hillside Pokey", 523178, Requirements([NozzleType.hover])),
        BlueCoin("Bridge Underside", 523183)
    ], parent_region="Bianco 3"),

    SmsRegion("Bianco 5", BIANCO, Requirements(location="Bianco Hills - Red Coins of Windmill Village"), shines=[
        Shine("Petey Piranha Strikes Back", 523004,
              Requirements([NozzleType.spray, NozzleType.rocket])),], blue_coins=[
    ...
    SmsRegion("Bianco 6", BIANCO, Requirements(location="Bianco Hills - Petey Piranha Strikes Back"), shines=[
    ...
    SmsRegion("Bianco 7", BIANCO, Requirements(location="Bianco Hills - The Secret of the Dirty Lake"), shines=[
        Shine("Shadow Mario on the Loose", 523006,
              Requirements([NozzleType.spray]))], blue_coins=[
    ...
    SmsRegion("Bianco 8", BIANCO, Requirements(location="Bianco Hills - Shadow Mario on the Loose"), shines=[
    ...
    # Gelato Beach
    SmsRegion("Gelato Entrance", GELATO, Requirements([NozzleType.spray], shines=5), [
    ...
    SmsRegion("Gelato 5-8", GELATO, Requirements(location="Gelato Beach - The Sand Bird is Born"), [
        ...
        Shine("It's Shadow Mario! After Him!", 523026, Requirements([NozzleType.splasher, NozzleType.hover])),
        Shine("The Watermelon Festival", 523027, Requirements([NozzleType.splasher]))], [
    ...
    # Sirena Beach
    SmsRegion("Sirena Entrance", SIRENA, Requirements(yoshi=True), [
    ...
    SmsRegion("Sirena 3-8", SIRENA, Requirements(location="Sirena Beach - The Hotel Lobby's Secret"), [
