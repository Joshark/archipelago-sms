...
SIRENA_BEACH_THREE_EIGHT: SmsRegion = SmsRegion(SmsRegionName.SIRENA_THREE_EIGHT,
    requirements=[Requirements(nozzles=[[NozzleType.yoshi]], location="Sirena Beach - The Hotel Lobby's Secret")],
...
SIRENA_BEACH_FOUR_FIVE: SmsRegion = SmsRegion(SmsRegionName.SIRENA_FOUR_FIVE,
    requirements=[Requirements(location="Sirena Beach - Mysterious Hotel Delfino")],
...
SIRENA_BEACH_FIVE_ONLY: SmsRegion = SmsRegion(SmsRegionName.SIRENA_FIVE_ONLY,
    requirements=[Requirements(location="Sirena Beach - The Secret of Casino Delfino")],
...
SIRENA_BEACH_SIX_ONLY: SmsRegion = SmsRegion(SmsRegionName.SIRENA_SIX_ONLY,
    requirements=[Requirements(location="Sirena Beach - King Boo Down Below")],
...
SIRENA_BEACH_SEVEN_EIGHT: SmsRegion = SmsRegion(SmsRegionName.SIRENA_SEVEN_EIGHT,
    requirements=[Requirements(location="Sirena Beach - Scrubbing Sirena Beach")],
